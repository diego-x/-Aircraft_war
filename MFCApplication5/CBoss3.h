...
public:
	...
	CBoss_2();
	~CBoss_2();
	CBoss_2(int x, int y, int m_nMotion);
	...
	CRect GetRect()
	{
		return CRect(CPoint(m_ptPos.x-100 , m_ptPos.y ), CPoint(m_ptPos.x + 250, m_ptPos.y + 100));
	}
	...
	//BOOL Fired();
private:
	static const int ENEMY_HEIGHT = 306;
	static const int ENEMY_width = 435;
